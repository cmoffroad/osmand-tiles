...
processObfsTiles({
  ...
  renderingProperties: 'lang=en,contourColorScheme=brown,contourDensity=high,contourLines=11,contourWidth=thin,groundSurveyMode=true,detailedColors=true,hideContour=false,hideContourLabels=true,showFixme=true',
